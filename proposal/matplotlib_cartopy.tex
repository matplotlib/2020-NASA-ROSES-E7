...
One of immediate benefit of this work will be to drastically improve
...
and Matplotlib, if configured properly, can be passed them for
unit-aware plotting.  \textbf{This capability it is currently used to
  support spaceflight operations by Monte, JPL's mission design and
  navigation software system} and the initial development was
supported by NASA.
...
libraries to register themselves.  Using this machinery users can
...
% what is wrong
However, there are several problems with the current unit support.
The unit support is under documented making it difficult for users to
...
By implementing all of the unit logic in the \texttt{DataSource}
