...
SMD community.  Soliciting on social media for examples of Matplotlib in SMD research
...
Sagittarius A* by the Event Horizon Telescope (EHT).
%   Support for
...
%% Getting too repetitive?  I think so.
...
and plotting method touched handles data with units correctly
