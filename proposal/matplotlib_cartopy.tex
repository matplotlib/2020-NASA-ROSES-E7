...
AstroPy~\cite{robitaille2013astropy} for astrophysics,
SunPy~\cite{sunpy_community2020}  for heliophysics, and
MetPy and Cartopy  for earth sciences; all of these use
...
Matplotlib's API: including yt, astropy, ArviZ, seaborn, xarray, and astropy.
% fast\_histogram doesn't have a plot component
